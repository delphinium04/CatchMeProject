...
public class Steal3ManagerScript : MonoBehaviour, IStealManager
{
    ...
    {
        Image box = UiTransform[11].GetComponent<Image>();
        TextMeshProUGUI stillornot = UiTransform[12].GetComponent<TextMeshProUGUI>();

        Button yesButton = UiTransform[13].GetComponent<Button>();
        Button noButton = UiTransform[14].GetComponent<Button>();
        Image yesImage = UiTransform[13].GetComponent<Image>();
        Image noImage = UiTransform[14].GetComponent<Image>();
        TextMeshProUGUI yestext = UiTransform[13].GetComponentInChildren<TextMeshProUGUI>();
        TextMeshProUGUI notext = UiTransform[14].GetComponentInChildren<TextMeshProUGUI>();
