...
public class Steal2ManagerScript : MonoBehaviour, IStealManager
{
    ...
    {
        Image box = UiTransform[9].GetComponent<Image>();
        TextMeshProUGUI stillornot = UiTransform[10].GetComponent<TextMeshProUGUI>();

        Button yesButton = UiTransform[11].GetComponent<Button>();
        Button noButton = UiTransform[12].GetComponent<Button>();
        Image yesImage = UiTransform[11].GetComponent<Image>();
        Image noImage = UiTransform[12].GetComponent<Image>();
        TextMeshProUGUI yestext = UiTransform[11].GetComponentInChildren<TextMeshProUGUI>();
        TextMeshProUGUI notext = UiTransform[12].GetComponentInChildren<TextMeshProUGUI>();
